...
justiça e da soberania como idealizações dependentes da astúcia, \emph{mētis}, essa qualidade ou habilidade essencialmente múltipla e
...
faria parte a produção e recepção da \emph{Teogonia}.}\looseness=-1
...
\begin{itemize}
\item \textsc{a.} \textbf{1--115}\quad Proêmio
\item \textsc{b.} \textbf{116--210}\quad Os primeiros deuses e os Titãs; primeiro estágio do mito de sucessão
\item \textsc{c.} \textbf{211--32}\quad Prole de Noite
\item \textsc{d-1.} \textbf{233--336}\quad Prole de Mar, incluindo as Nereidas
\item \textsc{d-2.} \textbf{337--70}\quad Prole de Oceano, incluindo as Oceânides
\item \textsc{e-1.} \textbf{371--403}\quad Uniões de outros Titãs e o episódio de Estige
\item \textsc{e-2.} \textbf{404--52}\quad Uniões de outros Titãs e o episódio de Hécate
\item \textsc{f-1.} \textbf{453--506}\quad União de Reia e Crono; segundo estágio do mito de sucessão
\item \textsc{g.} \textbf{507--616}\quad Prole de Jápeto e o episódio de Prometeu
\item \textsc{f-2.} \textbf{617--720}\quad Batalha com os Titãs (Titanomaquia) e fim do segundo estágio
\item \textsc{c.} \textbf{721--819}\quad Descrição do Tártaro
\item \textsc{b.} \textbf{820--80}\quad Batalha com Tifeu, o último inimigo de Zeus
\item \textsc{a.} \textbf{881--929 (?)}\quad Zeus torna-se rei e divide as honras; união com Astúcia e demais\footnote{O ponto de interrogação indica que não há consenso que verso nos manuscritos do poema marcaria o fim da composição (Kelly 2007).} 
\end{itemize}
...
que, mais tarde, passou a ser denominado ``hino'', \emph{humnos}.\footnote{O substantivo (que aparece uma vez na
...
Abismo, portanto, através da descendência de Noite, \emph{Nux}, e Briga, \emph{Eris}, revela que a separação entre Terra e Abismo nunca é total\footnote{As ações e emoções representadas como descendência de Abismo são
...
chamam deuses e varões, porque na espuma\footnote{\emph{Aphros}.}\\
foi criada; Citereia, pois alcançou Citera;\\
cipriogênita, pois nasceu em Chipre cercado-de-\qb{}-mar;\\
e ama-sorriso,\footnote{\emph{Philommeidea}.} pois da genitália\footnote{\emph{Mēdōn}.} surgiu.
\end{verse}
...
\tit{detienne}, M.; \textsc{vernant}, J.-P. \emph{Métis}: As astúcias da inteligência.
...
Próximo. Trad.: C. A. Zanon. \emph{Classica} v.\,32, n.\,2, 2019, p.\,119--38.
...
\tit{nagy}, G. Hesiod and the poetics of Pan-Hellenism. In: \line(1,0){25}. \emph{Greek
...
\titidem. A linhagem dos heróis na cosmologia hesiódica. \emph{Rónai} v.\,8, n.\,2, 2020, p.\,353--374.
...
\tit{snell}, B. O mundo dos deuses em Hesíodo. In: \line(1,0){25}. \emph{A cultura grega e
...
\tit{woodward}, R. D. Hesiod and Greek myth. In: \line(1,0){25}. (org.) \emph{The Cambridge

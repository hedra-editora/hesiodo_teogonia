...
\noindent{}\textls[-15]{\textit{O mais honesto ou o mais danado} é como Riobaldo descreve Zé
...
\textls[-20]{\textit{Mutatis mutandis} pode-se dizer o mesmo do poema de Hesíodo e de
...
imanente, focada no aqui e agora da experiência sempre cambiante.}\looseness=-1\footnote{``No
tremeluz\ldots{} muito veloz''.} \textls[-20]{E assim como em Rosa, mito e razão não
se revelam formas de pensamento opostas ou incompatíveis, em particular,
pela modo como, em Hesíodo, a linguagem e a narrativa desvelam o cosmo.}\looseness=-1
...
\textls[7]{Diferentemente dos poemas de Homero, os de Hesíodo se associam, eles
...
\textls[-20]{Indicações temporais, porém, estão virtualmente ausentes do poema, o que
...
chama de pan-helenismo,}\looseness=-1\footnote{Moraes (2019, p.\,12) entende ``o
  ...
  atuou na produção e reprodução da identidade helênica''.} \textls[-10]{e do qual
...
\textls[-20]{Com isso, o corte entre o chamado proêmio e o restante do poema é bem
...
tão poderoso ou merece ser tão celebrado como ele.}\looseness=-1
...
\textls[-15]{Isso pode ser exemplificado pelo nome \textit{Hesíodo}. Por certo não é
...
entre vários do que Vergados (2020) define como o pensamento etimológico do autor.}\looseness=-1
...
\textls[-15]{Para chegar a Zeus e o modo como esse controla o cosmo, o tema central
...
\textls[5]{Todos os deuses descendem de duas linhagens principais, a de Abismo e a
...
executadas ou sentidas pelos descendentes de Terra.} \textls[5]{e assim ilustra uma
...
\begin{enumerate}
\item \textls[15]{Os deuses do panteão --- sobretudo os Olímpicos, como Zeus, Apolo, Atena e Ártemis ---, cultuados pela Hélade mas de uma forma mais específica que aquela com que aparecem
...
\item \textls[15]{Partes do cosmo divinizados, como Terra, Noite, Montanhas; alguns eram cultuados;}

\item \textls[15]{Personificações. Elementos que,
...
\textls[10]{Essa tipologia, porém, não deve ser tomada como algo estático e
...
\textls[-20]{Um dos modos do poeta expressar o que cada divindade tem de específico é
...
esperma de Céu, \textit{Ouranos}, de Afrodite (192--200):}\looseness=-1
...
\textls[-20]{Ora, à medida que o narrador, devido ao encontro que teve com as Musas,
...
espaço para uma Afrodite, a filha de Céu.}\looseness=-1

\textls[-10]{O surgimento de Afrodite é um dos nascimentos que marcam o fim da
...
(Burkert, 1992; West, 1997; Rutherford, 2009; Haubold, 2013).}\looseness=-1

\section{Astúcia «versus» força e criaturas prodigiosas}

\textls[-10]{Os eventos do mito de sucessão são permeados por um par de opostos
...
\textls[15]{Não possuímos nenhum testemunho histórico independente da
...
\textls[10]{No caso da Mulher, ela é dada aos homens em troca do fogo: ao passo que
...
\textls[10]{Tifeu, por sua vez, adquire, devido à lógica da narrativa, o lugar de
...
\textls[10]{É nesse sentido que se deve entender o longo catálogo que finaliza o
...
mas, por outro, Harmonia.} \textls[10]{e finalmente um catálogo de deusas que se
...
\textls[10]{Para concluir, mencione-se que há uma discussão inconclusa sobre onde a
...
\textls[15]{Para definir o texto grego aqui traduzido, cotejaram-se as seguintes
...
\textls[-20]{Para facilitar a leitura, optou-se por seguir o que fazem a maioria dos
...
Trata-se, portanto, de um recurso eminentemente didático.}\looseness=-1
...
\textls[-20]{A numeração das notas de rodapé em forma de lemas segue o número que
indica um verso ou um conjunto de versos do poema.}\looseness=-1

\textls[-10]{Por fim, gostaria de agradecer àqueles que compartilharam comigo seu
...
Antonio-Orlando Dourado Lopes.}\looseness=-1

\begin{bibliohedra}
\tit{allan}, W. ``Divine justice and cosmic order in early Greek Epic''. In:
...
\tit{antunes}, C.\,L.\,B. ``26 hinos homéricos''. In: \textit{Cadernos de literatura em
tradução} v.\,15, p.\,13--23, 2015.

\tit{arnould}, D. ``Les noms des dieux dans la \textit{Théogonie} d'Hésiode:
étymologies et jeux de mots''. In: \textit{Revue des études grecques}, v.\,122,
2009, p.\,1--14.

\tit{arrighetti}, G. \textit{Esiodo opere}. Milão: Mondadori, 2007. %Introdução, tradução e comentário.

\tit{bakker}, E.\,J. ``Hesiod in performance''. In: \textsc{loney}, A.\,C.; \textsc{scully}, S. (org.) \textit{The Oxford Handbook of Hesiod}. Oxford: Oxford, 2018.
...
\tit{brandão}, J.\,L. \textit{Antiga Musa (arqueologia da ficção)}. Belo Horizonte: Relicário, 2015. % 2ª edição.

\tit{burkert}, \textls[-20]{W. \textit{The Orientalizing revolution: Near Eastern influence
on Greek culture in the early archaic age}. Cambridge: Harvard
University Press, 1992.}\looseness=-1
...
\tit{colonna}, A. \textit{Opere di Esiodo}. Turim: Unione Tipografico-Editrice,
1977.

\tit{detienne}, M. \textit{Os mestres da verdade na Grécia arcaica}. Rio de Janeiro: Jorge Zahar, 1988.
%Trad. A. Daher. 

\tit{detienne}, M.; \textsc{vernant}, J.\,P. \textit{Métis: As astúcias da inteligência}.
São Paulo: Odysseus, 2008. %Trad. F. Hirata. 

\tit{gagarin}, M. ``The poetry of justice: Hesiod and the origins of Greek law''. In: 
\textit{Ramus}, v.\,21, 1992, p.\,61--78.

\tit{haubold}, J. \textit{Greece and Mesopotamia: dialogues in literature}.
Cambridge: Cambridge University Press, 2013.

\tit{janda}, M. \textit{Über \emph{Stock und Stein}: die indogermanischen Variationen
...
\tit{kelly}, A. ``How to end an orally-derived epic poem?'' In: \textit{Transactions of
...
Próximo''. In: \textit{Classica}, v.\,32, n.\,2, 2019, p.\,119--38. % Trad.: C. A. Zanon.

\tit{koning}, H. \textit{Hesiod, the other poet: ancient reception of a
...
\tit{martin}, R.\,P. ``Hesiod, Odysseus, and the instruction of princes''. In: \textit{Transactions of the American Philological Association}, v.\,114,
1984, p.\,29--48.

\titidem. Hesiodic theology. In: \textsc{loney}, A.\,C.; \textsc{scully}, S. (org.) \textit{The
Oxford Handbook of Hesiod}. Oxford: Oxford, 2018.

\tit{meier-brügger}, M. ``Zu Hesiods Namen''. In: \textit{Glotta}, v.\,68, 1990, p.\,62--67.

\tit{moraes}, A.\,S. de. ``História e etnicidade: Homero à vizinhança do
pan-helenismo''. In: \textit{Hélade}, v.\,5, n.\,1, 2019, p.\,12--36.
...
\titidem. \textit{Hesiod: \emph{Theogony}, \emph{Works and Days}, \emph{Testimonia}}.
Cambridge: Harvard University Press, 2006.

\tit{muellner}, L.\,C. \textit{The anger of Achilles: \emph{mēnis} in Greek
epic}. Ithaca: Cornell University Press, 1996.

\tit{murray}, P. ``Poetic inspiration in early Greece''. In: \textit{Journal of Hellenic
Studies}, v.\,101, 1981, p.\,87--100.

\tit{nagy}, G. ``Hesiod and the poetics of Pan-Hellenism''. In: \textit{Greek
mythology and poetics}. Ithaca: Cornell Univesity Press, 1990, p.\,36--82. %\line(1,0){25}. 

\titidem. \textit{The best of the Achaeans: concepts of the hero in archaic Greek
poetry}. Baltimore: Johns Hopkins University Press, 1999. %2ª ed. 

\tit{oliveira}, J. ``\textit{Áurea Afrodite} e a ordem cósmica de Zeus na poesia
hesiódica''. In: \textit{Codex: Revista de estudos clássicos}. Rio de Janeiro,
v.\,7, n.\,2, 2019, p.\,69--80.

\titidem. ``A linhagem dos heróis na cosmologia hesiódica''. In: \textit{Rónai}, v.\,8, n.\,2, 2020, p.\,353--374.

\tit{pucci}, P. \textit{Hesiod and the language of poetry}. Baltimore: Johns
Hopkins University Press, 1977.

\titidem. \textit{Inno alle Muse (Esiodo, \emph{Teogonia}, 1--115): texto,
...
\tit{ricciardelli}, G. \textit{Esiodo: \emph{Teogonia}}. Milão: Fondazione Lorenzo
...
\tit{rowe}, C. J. ``Archaic thought in Hesiod''. In: \textit{Journal of Hellenic
...
\tit{scully}, S. \textit{Hesiod's \emph{Theogony}: from Near Eastern
creation myths to \emph{Paradise Lost}}. Oxford/\,Nova Iorque: Oxford
University Press, 2015.

\tit{snell}, B. ``O mundo dos deuses em Hesíodo''. In: \textit{A cultura grega e
as origens do pensamento}. São Paulo: Perspectiva, 2001. %\line(1,0){25}. 

\tit{snodgrass}, A.\,M. \textit{The Dark Age of Greece}. Edimburgo: Edinburgh
University Press, 1971.

\tit{thalmann}, W.\,G. \textit{Conventions of form and thought in early Greek
epic}. Baltimore/\,Londres: Johns Hopkins University Press, 1984.

\tit{torrano}, J.\,A.\,A. \textit{Hesíodo: \emph{Teogonia}. A origem dos deuses. Estudo
e tradução}. São Paulo: Iluminuras, 1992. %2\textsuperscript{a} edição

\titidem. ``O certame Homero--Hesíodo''. In: \textit{Letras clássicas}, n.\,9, p.\,215--24, 2005.
...
\tit{verdenius}, W.\,J. ``Notes on the proem of Hesiod's \textit{Theogony}''. In:
...
\tit{vernant}, \textls[-30]{J.\,P. \textit{Mito e sociedade na Grécia antiga}. Rio de Janeiro:
José Olympio, 1992.}\looseness=-1
...
\tit{west}, M.\,L. \textit{Hesiod, \emph{Theogony}: edited with prolegomena and
...
\tit{woodward}, \textls[-20]{R.\,D. ``Hesiod and Greek myth''. In: \textit{The Cambridge
companion to Greek mythology}. Cambridge: Cambridge University Press,
2007.}\looseness=-1 %\line(1,0){25}. 

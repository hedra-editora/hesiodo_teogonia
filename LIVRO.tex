...
\setRlineflag{} %Tirar o R da numeração de linha
\renewcommand{\numlabfont}{\normalfont\tiny} %Fonte da numeração de linha
\setlength{\linenumsep}{.2cm} %Distância da numeração de linha e da mancha de texto
\Xnotenumfont{\normalfont\bfseries} %Número do verso, na nota de rodapé, em bold
\Xarrangement{paragraph} %Footnotes em bloco

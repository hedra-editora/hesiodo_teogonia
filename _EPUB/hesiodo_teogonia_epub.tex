...
\textsc{burkert}, W. \textit{The Orientalizing revolution: Near Eastern influence
...
\textsc{lamberton}, R. \textit{Hesiod}. New Haven: Yale University Press, 1988.
...
\_\_\_\_. \textit{The best of the Achaeans: concepts of the hero in archaic Greek
...
\textsc{snodgrass}, A. M. \textit{The Dark Age of Greece}. Edinburgh: Edinburgh
...
\quad{}Pariu-lhes na Piéria,\footnote{região logo ao norte do Olimpo.} após se unir ao pai, o Cronida,\\
...
\quad{}E Noite pariu a medonha Sina,\footnote{\emph{Moros}.} Perdição\footnote{\emph{Kēr}.} negra\\
e Morte,\footnote{\emph{Thanatos}.} e pariu Sono,\footnote{\emph{Hupnos}.} e pariu a tribo de Sonhos;\footnote{\emph{Oneiros}.}\\
sem se deitar com um deus, pariu a escura Noite.\footnote{``escura'', \emph{erebennē}, parece remeter à Escuridão, \emph{Erebos}, parceiro sexual de Noite no início da cosmogonia.}\\
Em seguida, Pecha\footnote{\emph{Momos}.} e aflitiva Agonia,\footnote{\emph{Oizus}.}\\
e Hespérides, que, para lá do glorioso Oceano, de belas \\
maçãs de ouro cuidam e das árvores que trazem o fruto;\\
e gerou as Moiras\footnote{Destino, Quinhão.} e Perdições castigo-implacável,\\
Fiandeira,\footnote{\emph{Klotō}.} Sorteadora\footnote{\emph{Lakhesis}.} e Inflexível,\footnote{\emph{Atropos}.} elas que aos mortais,\\
...
Também pariu Indignação,\footnote{\emph{Nemesis}.} desgraça aos humanos mortais,\\
a ruinosa Noite; depois pariu Farsa\footnote{\emph{Apatē}.} e Amor\footnote{\emph{Philotēs}.}\\
e a destrutiva Velhice,\footnote{\emph{Geras}.} e pariu Briga\footnote{\emph{Eris}.} ânimo-potente. 

\quad{}E a odiosa Briga pariu o aflitivo Labor,\footnote{\emph{Ponos}.}\\
Esquecimento,\footnote{\emph{Lēthē}.} Fome,\footnote{\emph{Limos}.} Aflições\footnote{\emph{Algos}.} lacrimosas,\\
Batalhas,\footnote{\emph{Husminē}.} Combates,\footnote{\emph{Makhē}.} Matanças,\footnote{\emph{Phonos}.} Carnificinas,\footnote{\emph{Androktasia}.}\\
Disputas,\footnote{\emph{Neikos}.} Embustes,\footnote{\emph{Pseudos}.} Contos,\footnote{\emph{Logos}.} Contendas,\footnote{\emph{Amphillogia}.}\\
Má-Norma\footnote{\emph{Dusnomia}.} e Desastre,\footnote{\emph{Atē}.} vizinhas recíprocas, \\
e Jura,\footnote{\emph{Horkos}.} ela que demais aos homens mortais\\
...
e Amplaforça\footnote{\emph{Eurubiē}.} com ânimo de adamanto no íntimo.\\
E de Nereu nasceram numerosas filhas de deusas, \\
no mar ruidoso, com Dóris\footnote{o seu nome também remete à raiz verbal de ``dar'', elemento presente em algumas de suas filhas.} belas-tranças,\\
filha do circular rio Oceano:\\
Propele,\footnote{\emph{Prothō}.} Completriz,\footnote{\emph{Eukrantē}.} Salva,\footnote{\emph{Saō}.} Anfitrite,\\
Tétis, Dadivosa,\footnote{\emph{Eudōrē}.} Calmaria,\footnote{\emph{Galēnē}.} Azúlis,\footnote{\emph{Glaukē}.}\\
Ondacélere,\footnote{\emph{Kumothoē}.} a veloz Gruta,\footnote{\emph{Speiē}.} a desejável Festa,\footnote{\emph{Thalia}. Alguns críticos, como Mazon e Ricciardelli, defendem, para a segunda metade do verso, ``\ldots{} Gruta, Veloz e a desejável \emph{Marinha}''.} \\
Admiradíssima,\footnote{\emph{Pasiteē}.} Saudosa,\footnote{\emph{Eratō}.} Belarrixa\footnote{\emph{Eunikē}.} braço-róseo,\\
a graciosa Amelada,\footnote{\emph{Melitē}.} Enseada,\footnote{\emph{Eulimenē}.} Resplende,\footnote{\emph{Agauē}.}\\
Doadora,\footnote{\emph{Dōtō}.} Inicia,\footnote{\emph{Prōtō}.} Levadora,\footnote{\emph{Pherousa}.} Poderosa,\footnote{\emph{Dunamenē}.}\\
Ilhoa,\footnote{\emph{Nēsaiē}.} Costeira,\footnote{\emph{Aktaiē}.} Primazia,\footnote{\emph{Prōtomedeia}.}\\
Dóris, Tudovê,\footnote{\emph{Panopē}.} a benfeita Galateia, \\
a desejável Hipocorre,\footnote{\emph{Hippotoē}.} Hipomente\footnote{
\emph{Hipponoē}.} braço-róseo,\\
Seguronda,\footnote{\emph{Kumodokē}.} que ondas no mar embaciado\\
e rajadas de ventos bravios com Cessonda\footnote{\emph{Kumatolēgē}.}\\
...
Astúcia,\footnote{\emph{Mētis}.} Eurínome e Círcula\footnote{\emph{Telestō}.} peplo-açafrão,\\
...
\quad{}Lá habita a deusa, estigma\footnote{procura reproduzir a sugestão poética de que ``Estige'', \emph{Stux}, derivaria de ``odioso'', \emph{stugeros}; no
...
\quad{}E Nauveloz\footnote{\emph{Nausithoos}.} para Odisseu Calipso, diva entre as deusas,\\
